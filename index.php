...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-122837117-1"></script>
    <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'UA-122837117-1');
    </script>
    <!-- Tag Manager -->
    ...
    <meta name=Keywords content="developpeur, web, developpement, sites, internet, vendee, informatique, roche sur yon, roche-sur-yon, matthias goudjil">
</head>
